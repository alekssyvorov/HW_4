...
namespace example
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 1. Завдання
            // Зробити логічний зсув (logical shift) змінної 'mask' таким чином, щоб
            // змогли розшифрувати слово у змінній 'word' 

            // маска
            int mask = 0b0001100; // 0000 1100;
            string word = string.Empty;
            mask = mask << 2;
            // Зашифроване слово 0000 1100
            int w = 82;
            int o = 85;
            int r = 67;
            int d = 68;
            // Розшифрувати слово використовуючи якусь одну побітову операцію до кожної
            // змінної(замінити '?' на якусь побітову операцію)
            w = w ^ mask;
            o = o ^ mask;
            r = r ^ mask;
            d = d ^ mask;
